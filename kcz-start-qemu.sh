...
LEGACY_BIOS="/usr/share/seabios/bios-256k.bin"
GUEST_IMG=""
DEFAULT_GUEST_IMG="./kcz-emr-bkc-centos-stream-9-coreserver-host-6.2-19.2-52.img"
#DEFAULT_GUEST_IMG="./emr-bkc-centos-stream-9-coreserver-host-6.2-19.2-52.img"
KERNEL=""
#DEFAULT_KERNEL="../linux-6.16.5/arch/x86/boot/bzImage"
DEFAULT_KERNEL="./vmlinuz-6.2.0-emr.bkc.6.2.19.2.52.x86_64"
VM_TYPE="legacy"
BOOT_TYPE="direct"
DEBUG=false
USE_VSOCK=false
...
FORWARD_PORT=10026
MONITOR_PORT=9001
# KCZ: reserve vPRM that is hard-coded in the TDX module
KERNEL_CMD_NON_TD="root=/dev/vda3 rw selinux=0 console=hvc0 memmap=0x40000000%0x3c0000000-1+2"
...
process_args() {
    ...
    case ${VM_TYPE} in
        "td")
            ...
            QEMU_CMD+=" -object tdx-guest,id=tdx,sept-ve-disable=on \
			-object memory-backend-memfd-private,id=ram1,size=16G  -machine memory-backend=ram1 -m 16G  "
	    ...
	    QEMU_CMD+=" -object memory-backend-epc,id=mem1,size=64M,prealloc=on -M sgx-epc.0.memdev=mem1,sgx-epc.0.node=0 "
            ;;
        *)
